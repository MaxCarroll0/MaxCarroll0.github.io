...
<div class="display-math">\begin{align*} n = &\lambda x.\lambda y.\ x + y\quad &\Rightarrow^{\texttt{view}}\quad \lambda_{\color{red}\mathbb{0}}.\ \lambda_{\color{royalblue} \mathbb{1}}.\ & \mathbb{0} + \mathbb{1}\\ 
& & & \quad\vdots\\ 
& & & \textit{(edits)}\\ 
& & & \quad \vdots\\ 
