...
n = &\lambda x.\ lambda y.\ x + y\quad &\Rightarrow^{\texttt{view}}\quad \lambda_{\color{green}\mathbb{0}}.\ \lambda_{\color{royalblue} \mathbb{1}}.\& \mathbb{0} + \mathbb{1}\\
& & & \vdots\\
& & & \textit{(edits)}\\
& & & \vdots\\
&\lambda x.\ lambda y.\ y + x\quad &\Leftarrow^{\texttt{set n}}\quad \lambda_{\color{green}\mathbb{0}}.\ \lambda_{\color{royalblue} \mathbb{1}}.\& {\color{royalblue}\mathbb{1}} + {\color{green}\mathbb{0}}
\end{align*}</div>
